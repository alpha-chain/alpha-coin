...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("041c1effadd867cbb0f1b0ea521da7b637d931a9591a9b886faa628c2037c043a7e6a1a6dd62e39c52f4374637a362e2ab364a5d76082ced818ed122c5303901da") << OP_CHECKSIG;
...
//        vSeeds.emplace_back("seed.btc.petertodd.org", true); // Peter Todd, only supports x1, x5, x9, and xd
        ...
        chainTxData = ChainTxData{
            ...
            1513400865, // * UNIX timestamp of last known number of transactions
